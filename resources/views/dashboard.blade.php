                            ...
                            <div class="col-md-4 col-xl-3">
                                <div class="card bg-c-green order-card">
                                    <div class="card-block">
                                        ...
                                        <h2 class="text-right"><i
                                                class="fa fa-rocket f-left"></i><span>&nbsp;&nbsp;1</span></h2>
                            ...
                            <div class="col-md-4 col-xl-3">
                                <div class="card bg-c-pink order-card">
                                    <div class="card-block">
                                        ...
                                        <h2 class="text-right"><i
                                                class="fa fa-credit-card f-left"></i><span>{{ $listings?->users_count }}</span>
                                        </h2>
                                        <p class="m-b-0">Your applicants<span
                                                class="f-right">{{ $listings?->users_count }}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
